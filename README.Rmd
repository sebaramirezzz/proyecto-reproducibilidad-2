...
- [`DESCRIPTION`](https://github.com/sebaramirezzz/proyecto reproducibilidad 2/tree/main/DESCRIPTION):
contains project metadata (authors, date, dependencies, etc.)

- [`make.R`](https://github.com/sebaramirezzz/proyecto reproducibilidad 2/tree/main/make.R):
main R script to run the entire project

- [`R/`](https://github.com/sebaramirezzz/proyecto reproducibilidad 2/tree/main/R):
...
Launch the [`make.R`](https://github.com/sebaramirezzz/proyecto reproducibilidad 2/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/sebaramirezzz/proyecto reproducibilidad 2/blob/main/CONTRIBUTING.md).
